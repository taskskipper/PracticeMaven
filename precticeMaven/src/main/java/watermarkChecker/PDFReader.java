...
public class PDFReader {
	...
	public void PDFBoxExtractImages(PDDocument document) throws Exception {
	    ...
	    System.out.println(getPDFImagesCount(document));
	    ...
	    for (PDPage page : list) {
	        ...
	        for (COSName c : pdResources.getXObjectNames()) {
	            ...
	            if (o instanceof org.apache.pdfbox.pdmodel.graphics.image.PDImageXObject) {
	                ...
	                File file = new File("C:\\Users\\acer\\git\\PracticeMaven\\precticeMaven\\pdfImages\\" + System.nanoTime() + ".png");
        ...
        if ((width1 != width2) || (height1 != height2))
            ...
            for (int y = 0; y < height1; y++) {
                ...
                for (int x = 0; x < width1; x++) {
                    ...
                    differenceR += Math.abs(redA - redB);
                    differenceG += Math.abs(greenA - greenB);
                    differenceB += Math.abs(blueA - blueB);
                }
            }
  
            System.out.println(differenceR);
            System.out.println(differenceG);
